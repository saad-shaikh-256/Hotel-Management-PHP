...
<body>
   ...
   <section class="Services" id="Services">
      <div class="text">
         ...
         <div class="heading"><span>Explore Our</span> <span>Services</span> </div>
      </div>
      <div class="cards">
         <div class="card">
            <div class="iconBorder">
               <svg id="Layer_1" viewBox="0 0 24 24" width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" fill="#3e48a8" data-name="Layer 1">
            ...
            <div class="text">
               ...
               <div class="description">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magnam nemo aperiam doloremque vel eaque laboriosam quos accusamus eius natus delectus!
               </div>
            </div>
         </div>
         ...
         <div class="card">
            <div class="iconBorder">
               <svg xmlns="http://www.w3.org/2000/svg" fill="#3e48a8" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="32px" height="32px">
         ...
         <div class="card">
            <div class="iconBorder">
               <svg xmlns="http://www.w3.org/2000/svg" fill="#3e48a8" width="32px" height="32px" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
         ...
         <div class="card">
            <div class="iconBorder">
               <svg xmlns="http://www.w3.org/2000/svg" fill="#3e48a8" id="Layer_1" data-name="Layer 1" width="32px" height="32px" viewBox="0 0 24 24">
         ...
         <div class="card">
            <div class="iconBorder">
               <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" fill="#3e48a8" data-name="Layer 1" viewBox="0 0 24 24" width="32px" height="32px">
         ...
         <div class="card">
            <div class="iconBorder">
               <svg id="Layer_1" width="32px" height="32px" fill="#3e48a8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
